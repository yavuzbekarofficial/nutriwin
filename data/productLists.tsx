...
export const urunler: UrunDetay[] = [
  ...
  },
  {
    ...
    group: "besleme",
    kullanimAmaci: [
      "Gelişmiş Beslenme Desteği: Vitamin, mineral ve şelatların güçlü birleşimi, ruminantların büyümesini ve gelişimini destekler.",
      "Bağışıklık Sistemi Güçlendirmesi: Vitamin C, E, D ve mikro minerallerle desteklenen bu formül,bağışıklık fonksiyonlarını güçlendirir.",
      "Sindirim Desteği: Saccharomyces Cerevisiae ve Klinioptilolit gibi bileşenler, sindirimi iyileştirir ve yem verimliliğini artırır.",
      "Kemik ve İskelet Sağlığı: Vitamin D3, kalsiyum karbonat ve fosfor içeriği, kemik yapısını güçlendirir ve iskelet gelişimini teşvik eder.",
      "Antioksidan Savunma: Vitamin E ve Sodyum Selenit gibi bileşenler, hücre yenilenmesini ve genel sağlık desteğini sağlar.",
    ],
    etkiAlani: [
      "Vitaminler",
      "Mineraller ve Şelatlar",
      "Destekleyici Bileşenler ve Katkılar",
    ],
  ...
  },
  {
    ...
    group: "besleme",
    kullanimAmaci: [
      "Büyüme ve Gelişim Desteği: Vitamin ve minerallerin güçlü kombinasyonu, genç ruminantların sağlıklı büyümesini ve gelişmesini destekler.",
      "Bağışıklık Güçlendirme: İçeriğindeki vitamin C, E, A ve mineraller, bağışıklık sistemini güçlendirerek hastalıklara karşı direnç sağlar.",
      "Kemik Sağlığı: Vitamin D, kalsiyum ve fosforun etkin emilimini sağlayarak, kemik ve iskelet gelişimini teşvik eder.",
      "Enerji ve Metabolizma Desteği: Vitamin B kompleks bileşenleri ve demir, enerji üretimini artırarak metabolizmanın düzgün çalışmasını sağlar.",
      "Hücre Yenilenmesi ve Antioksidan Savunma: Vitamin E ve C, vücutta serbest radikal birikimini engelleyerek hücre sağlığını destekler.",
    ],
    etkiAlani: ["Vitaminler", "Mineraller"],
    ambalaj: ["1 kg"],
  },
  {
    slug: "winmast",
