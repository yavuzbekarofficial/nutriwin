      ...
      <div className="flex flex-col items-center mb-8">
        <div>
          <h2
            ...
            className="font-bold text-4xl text-red-500 text-center"
          >
          ...
          <Fade key={productGroupList.slug} triggerOnce>
            <div className="relative w-full h-[400px] rounded-lg overflow-hidden shadow-md group cursor-pointer">
              <Image
                ...
                alt={`Nutriwin ${productGroupList.title[currentLocale]} — Hayvansal ilaçlar`}
                fill
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6 bg-black/50 transition-all duration-300">
                ...
                >
                  <a
                    aria-label={`Nutriwin ${productGroupList.title[currentLocale]} ürünlerini gör`}
                    className="bg-red-600 text-white font-semibold text-center px-6 py-2 rounded-full transform translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300"
                  >
